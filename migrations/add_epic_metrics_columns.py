...
def upgrade():
    ...
    op.add_column(
        "epics", sa.Column("estimated_duration_days", sa.Integer, nullable=True)
    )
    ...
    op.add_column(
        "epics",
        sa.Column(
            "initial_scope_estimate", sa.Integer, nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "epics",
        sa.Column(
            "scope_creep_percentage", sa.Float, nullable=False, server_default="0.0"
        ),
    )
    op.add_column(
        "epics",
        sa.Column(
            "velocity_points_per_sprint", sa.Float, nullable=False, server_default="0.0"
        ),
    )
    op.add_column(
        "epics", sa.Column("team_size", sa.Integer, nullable=False, server_default="1")
    )
    ...
    op.add_column(
        "epics",
        sa.Column("defect_density", sa.Float, nullable=False, server_default="0.0"),
    )
    op.add_column(
        "epics",
        sa.Column(
            "test_coverage_percentage", sa.Float, nullable=False, server_default="0.0"
        ),
    )
    op.add_column(
        "epics",
        sa.Column("code_review_score", sa.Float, nullable=False, server_default="0.0"),
    )
    op.add_column(
        "epics",
        sa.Column(
            "technical_debt_hours", sa.Integer, nullable=False, server_default="0"
        ),
    )
    ...
    op.add_column(
        "epics",
        sa.Column(
            "business_impact_score", sa.Float, nullable=False, server_default="0.0"
        ),
    )
    op.add_column(
        "epics",
    ...
    op.add_column(
        "epics",
        sa.Column("user_adoption_rate", sa.Float, nullable=False, server_default="0.0"),
    )
    ...
    op.create_index(
        "idx_epic_timeline", "epics", ["planned_start_date", "planned_end_date"]
    )
    op.create_index(
        "idx_epic_velocity",
        "epics",
        ["velocity_points_per_sprint", "completion_percentage"],
    )
    op.create_index(
        "idx_epic_quality", "epics", ["defect_density", "test_coverage_percentage"]
    )
    op.create_index(
        "idx_epic_business_impact", "epics", ["business_impact_score", "roi_percentage"]
    )
