...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_epic_id", sa.Integer, sa.ForeignKey("epics.id"), nullable=False
        ),
        sa.Column(
            "dependent_epic_id", sa.Integer, sa.ForeignKey("epics.id"), nullable=False
        ),
        # Type et priorité
        sa.Column(
            "dependency_type", sa.String(20), nullable=False, default="prerequisite"
        ),
        ...
        sa.Column(
            "validation_status", sa.String(20), nullable=False, default="pending"
        ),
        # Contraintes
        sa.UniqueConstraint(
            "parent_epic_id",
    ...
    op.create_index(
        "idx_epic_dep_type_priority",
        "epic_dependencies",
        ["dependency_type", "priority"],
    )
    op.create_index(
        "idx_epic_dep_active", "epic_dependencies", ["is_active", "is_resolved"]
    )
    op.create_index(
        "idx_epic_dep_validation",
        "epic_dependencies",
