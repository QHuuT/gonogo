...
def upgrade():
    ...
    op.add_column('epics', sa.Column('metrics_cache_updated_at', sa.DateTime, nullable=True))
    ...
    op.create_index('ix_epic_metric_history_epic_time', 'epic_metric_history', ['epic_id', 'captured_at'])
