...
all_user_stories = [
    ...
    ('US-00031', 'Complete test runner plugin integration and fix Unicode encoding issues', 29, 'EP-00007'),
    ('US-00032', 'Enhanced archive management with current report tracking and automated cleanup', 34, 'EP-00007'),
    ('US-00033', 'GitHub Actions automation for issue management and epic linking', 37, 'EP-00004'),
    ('US-00034', 'Enhance RTM Matrix Filters with Dropdown and Multiple Criteria Selection', 86, 'EP-00005'),
    ('US-00035', 'Implement Component Inheritance System', 76, 'EP-00005'),
    ('US-00037', 'Design RTM Component Display UI and Responsive Layout', 81, 'EP-00005'),
    ...
    ('US-00043', 'Complete cleanup of legacy RTM system files and infrastructure', 69, 'EP-00005'),
    ('US-00051', 'Requirements analysis and impact assessment for database RTM migration', 51, 'EP-00005'),
    ('US-00052', 'Database schema design for traceability relationships', 52, 'EP-00005'),
    ...
    ('US-00062', 'Program Areas/Capabilities - Epic Grouping and Strategic Management', 98, 'EP-00010'),
    ...
    ('US-00078', 'Visual Filtering Enhancement for Epic Dependencies Graph', 99, 'EP-00010'),
    ('US-00079', 'Enhance RTM Dashboard Component Display and UI Layout', 80, 'EP-00005'),
    ('US-00080', 'Implement Blocked Flag System for All Issue Types', 79, 'EP-00005'),
    ('US-00081', 'Enhance Component Badge Placement in RTM Epic Headers', 83, 'EP-00005')
]
...
print(f'')
print(f'COMPLETE DATABASE RESTORED:')
