    ...
    try:
        ...
        for issue in issues:
            ...
            if us_id:
                ...
                existing = session.query(UserStory).filter(
        ...
        if not dry_run:
            ...
            print(f"Would create user stories (dry run)")
    ...
    try:
        ...
        for issue in issues:
            ...
            if def_id:
                ...
                existing = session.query(Defect).filter(
...
def main():
    ...
    parser.add_argument('--entity-type', choices=['user-stories', 'defects', 'all'], default='all',
