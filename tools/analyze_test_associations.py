...
class TestAssociationAnalyzer:
    def __init__(self, test_root="tests"):
        ...
        self.associations = defaultdict(lambda: {
            'user_stories': set(),
            'epics': set(),
            'components': set(),
            'test_type': None,
    ...
    def _extract_components_from_bdd_tags(self, content: str) -> Set[str]:
        ...
        component_keywords = ['backend', 'frontend', 'database', 'security', 'auth',
                             'blog', 'comment', 'gdpr', 'api', 'ui']
    ...
    def generate_report(self, associations: Dict):
        ...
        # Sample associations
        print(f"SAMPLE ASSOCIATIONS (first 5):")
