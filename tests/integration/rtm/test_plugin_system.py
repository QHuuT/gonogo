...
from shared.utils.rtm_plugins.base_link_generator import BaseLinkGenerator, GitHubIssueLinkGenerator
from shared.utils.rtm_plugins.base_validator import BaseValidator, StandardValidator
from shared.utils.rtm_plugins.base_rtm_parser import BaseRTMParser, StandardMarkdownParser
...
'''
            ...
            temp_plugin = next(
                (p for p in link_generators if p['name'] == 'temp_generator'),
                None
            )
