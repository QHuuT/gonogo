...
class CapabilityDependency(Base):
    ...
    # Relationships
    parent_capability = relationship("Capability", foreign_keys=[parent_capability_id], back_populates="dependencies_as_parent")
    dependent_capability = relationship("Capability", foreign_keys=[dependent_capability_id], back_populates="dependencies_as_dependent")
