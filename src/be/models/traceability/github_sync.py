...
class GitHubSync(TraceabilityBase):
    ...
    def __init__(self, github_issue_number: int, github_issue_type: str, github_issue_title: str, **kwargs):
    ...
    def __repr__(self):
        return f"<GitHubSync(issue_number={self.github_issue_number}, type='{self.github_issue_type}', status='{self.sync_status}')>"