...
class EpicMetricHistory(Base):
    ...
    epic_id = Column(Integer, ForeignKey('epics.id', ondelete='CASCADE'), nullable=False, index=True)
    ...
    def __init__(self, epic_id: int, metrics: str, captured_at: Optional[datetime] = None, **kwargs):
