...
Implements force-directed layout algorithm and interactive features server-side.

Related Issue: US-00030 - Visual Filtering Enhancement for Epic Dependencies Graph
